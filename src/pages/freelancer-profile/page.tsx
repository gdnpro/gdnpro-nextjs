...
export default function FreelancerProfilePage() {
  ...
  const loadCompletedProjects = async (freelancerId) => {
    try {
  ...
  const loadFreelancerProfile = async () => {
    try {
      ...
      const matchedFreelancer = profiles?.find((profile) => {
        ...
        return removeAccents(profileSlug) === removeAccents(slug)
      })
              ...
              <div className="flex items-center mb-4 md:mb-0">
                <div className="relative">
                  {freelancer.avatar_url ? (
                    ...
                    <div className="w-24 h-24 bg-gradient-to-br from-cyan-400 to-primary rounded-full flex items-center justify-center">
