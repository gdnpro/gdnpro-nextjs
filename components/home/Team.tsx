          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                {/* En escritorio, ocultos por defecto, solo visibles en hover */}
                <div
                  className={`absolute bottom-4 left-4 right-4 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-all ${
                    index === 1 ? "hidden" : "" // Oculta los iconos en la segunda card
                  }`}
                >
